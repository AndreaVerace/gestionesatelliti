			...
			<main class="flex-shrink-0">
			  <div class="container">
					...
					<spring:hasBindErrors  name="insert_impiegato_attr">
			  		...
			  		<div class="alert alert-danger alert-dismissible fade show ${messageData==null?'d-none':'' }" role="alert">
					  ${messageData}
					  <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close" ></button>
					</div>
			  		
			  			<div class="alert alert-danger alert-dismissible fade show ${messageStato==null?'d-none':'' }" role="alert">
					  ${messageStato}
					  <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close" ></button>
					</div>
			  ...
			  <div class='card'>
				    ...
				    <div class='card-body'>
							...
							<form:form modelAttribute="edit_satellite_attr" method="post" action="${pageContext.request.contextPath}/satellite/update" class="row g-3" novalidate="novalidate">
								...
								<div class="col-md-6">
									...
									<spring:bind path="denominazione">
										<input type="text" name="nome" id="denominazione" class="form-control ${status.error ? 'is-invalid' : ''}" placeholder="Inserire la denominazione" value="${edit_satellite_attr.denominazione }" required>
									</spring:bind>
							...
							<div class="col-12">
								<spring:bind path="id">
								<input type="hidden" name="id" value="${edit_satellite_attr.id }" id="id">
								</spring:bind>
