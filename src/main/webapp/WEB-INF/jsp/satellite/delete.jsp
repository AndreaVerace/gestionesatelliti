	 ...
	 <head>
	   ...
	   <body class="d-flex flex-column h-100">
			...
			<main class="flex-shrink-0">
			  ...
			  <div class="alert alert-danger alert-dismissible fade show ${messageError==null?'d-none':'' }" role="alert">
					  ${messageError}
			  		...
			  		<div class='card'>
					    ...
					    <div class='card-body'>
					    	...
					    	<form:form  method="post" action="${pageContext.request.contextPath}/satellite/remove" class="row g-3" novalidate="novalidate">
						    	<div class="col-12">
						    		<input type="hidden" name="idSatelliteDaEliminare" value="${delete_satellite_attr.id }">
